...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Location",
      type: "string",
      description: "E.g., 'São Paulo, BR' or 'Remote'",
    }),
    defineField({
      name: "availability",
      ...
      options: {
        list: [
          { title: "Disponível para contratação", value: "available" },
          { title: "Aberto a oportunidades", value: "open" },
          { title: "Não estou procurando", value: "unavailable" },
        ],
      },
    }),
    defineField({
    ...
    defineField({
      ...
      type: "file",
      description: "Upload your resume/curriculum PDF file",
      options: {
