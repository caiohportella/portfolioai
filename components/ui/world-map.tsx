...
export default function WorldMap({
  ...
  // Use resolvedTheme which is more stable, default to light theme for SSR
  const dotColor = useMemo(() => {
    if (!mounted) return "#00000040"; // Default for SSR
    return resolvedTheme === "dark" ? "#FFFFFF40" : "#00000040";
