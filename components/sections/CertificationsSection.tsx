            ...
            {certifications.map((cert) => (
              ...
              >
                ...
                >
                  ...
                  <div className="relative bg-linear-to-b from-zinc-900 via-zinc-900 to-zinc-950 dark:from-zinc-950 dark:via-black dark:to-zinc-950 border-2 border-yellow-600/40 p-8 flex flex-col min-h-[450px]">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center flex-1">
                      ...
                      <div className="mb-5">
                        ...
                        <p className="text-xs text-yellow-600/80 italic">para</p>
                      </div>
                          ...
                          {cert.expiryDate && (
                            <div className="text-center">
                              ...
                              >
                                ...
                                {isExpired(cert.expiryDate) && " (Expirado)"}
                              </span>
                            </div>
                          )}
                          {cert.credentialId && (
